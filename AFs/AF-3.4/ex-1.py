...
for i in range(2):
  threads_produtor.append(Thread(target=produtor))
  threads_produtor[i].start()

for i in range(2):
  threads_consumidor.append(Thread(target=consumidor))
  threads_consumidor[i].start()

for i in range(2):
  threads_produtor[i].join()

for i in range(2):
  threads_consumidor[i].join()
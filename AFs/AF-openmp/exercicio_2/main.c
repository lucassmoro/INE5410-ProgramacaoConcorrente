...
/*O erro do estagiário foi nao ter privado as variaveis i, j, k pois 
fez com que elas fossem acessadas simultaneamente gerando um 
resultado errôneo e instável*/
